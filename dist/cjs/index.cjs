...
var ArrayExtensions = new import_extension.Patch(Array, {
  /**
...
var { ifArray: pIfArray } = ArrayExtensions.patches;
var ArrayPrototypeExtensions = new import_extension.Patch(Array.prototype, {
  [import_extension.Patch.kMutablyHidden]: {
    ...
    variants() {
      ...
      Object.defineProperty(result, "check", {
        value(position) {
          if (typeof position !== "number" && position >= 0 && position < this.order.length) {
            return false;
          }
...
function isThenElse(bv, tv, ev) {
  ...
  if (arguments.length > 1) {
    var _then = isFunction2(tv) ? tv(bv) : tv;
    if (arguments.length > 2) {
      var _else = isFunction2(ev) ? tv(bv) : ev;
...
// src/big.int.extension.js
var import_extension2 = require("@nejs/extension");
var BigIntExtensions = new import_extension2.Patch(BigInt, {
  [import_extension2.Patch.kMutablyHidden]: {
    /**
    ...
    ifBigInt(value, thenValue, elseValue) {
      return isThenElse2(this.isBigInt(value), thenValue, elseValue);
    },
    /**
...
var { isBigInt: pIsBigInt, ifBigInt: pIfBigInt } = BigIntExtensions.patches;
var BigIntPrototypeExtensions = new import_extension2.Patch(BigInt.prototype, {
  /**
...
// src/function.extensions.js
var import_extension3 = require("@nejs/extension");
var FunctionExtensions = new import_extension3.Patch(Function, {
  [import_extension3.Patch.kMutablyHidden]: {
    /**
    ...
    isAsync(value) {
      ...
      return value instanceof Function && stringTag.includes("Async");
    },
    /**
    ...
    ifAsync(value, thenValue, elseValue) {
      return isThenElse3(this.isAsync(value), thenValue, elseValue);
    },
    /**
    ...
    isAsyncGenerator(value) {
      ...
      return value instanceof Function && stringTag == "AsyncGeneratorFunction";
    },
    /**
    ...
    ifAsyncGenerator(value, thenValue, elseValue) {
      return isThenElse3(this.isAsyncGenerator(value), thenValue, elseValue);
    },
    /**
     ...
     */
    isBigArrow(value) {
      return value instanceof Function && String(value).includes("=>") && !String(value).startsWith("bound") && !Reflect.has(value, "prototype");
    },
    /**
    ...
    ifBigArrow(value, thenValue, elseValue) {
      return isThenElse3(this.isBigArrow(value), thenValue, elseValue);
    },
    /**
     ...
     */
    isBound(value) {
      return value instanceof Function && String(value).startsWith("bound") && !Reflect.has(value, "prototype");
    },
    /**
    ...
    ifBound(value, thenValue, elseValue) {
      return isThenElse3(this.isBound(value), thenValue, elseValue);
    },
    /**
    ...
    ifClass(value, thenValue, elseValue) {
      return isThenElse3(this.isClass(value), thenValue, elseValue);
    },
    /**
    ...
    ifFunction(value, thenValue, elseValue) {
      return isThenElse3(this.isFunction(value), thenValue, elseValue);
    },
    /**
    ...
    isGenerator(value) {
      const stringTag = getStringTag(value);
      return value instanceof Function && stringTag == "GeneratorFunction";
    },
    /**
    ...
    ifGenerator(value, thenValue, elseValue) {
      return isThenElse3(this.isGenerator(value), thenValue, elseValue);
    },
    /**
    ...
    StringTagHasInstance(Class) {
      Object.defineProperty(Class, Symbol.hasInstance, {
        value: function stringTagAwareHasInstance(fn) {
          ...
          return fn[Symbol.toStringTag] === this.name || fn instanceof this;
        }
      });
    }
  }
...
var {
  isAsyncGenerator: pIsAsyncGenerator,
  ifAsyncGenerator: pIfAsyncGenerator,
  isAsync: pIsAsync,
  ifAsync: pIfAsync,
  isBigArrow: pIsBigArrow,
  ifBigArrow: pIfBigArrow,
  isBound: pIsBound,
  ifBound: pIfBound,
  isClass: pIsClass,
  ifClass: pIfClass,
  isFunction: pIsFunction,
  ifFunction: pIfFunction,
  isGenerator: pIsGenerator,
  ifGenerator: pIfGenerator
} = FunctionExtensions.patches;
var FunctionPrototypeExtensions = new import_extension3.Patch(Function.prototype, {
  [import_extension3.Patch.kMutablyHidden]: {
    /**
     * Determines if a given value is an asynchronous function. It checks if the
     * value is an instance of `Function` and if its string representation
...
var copy_object_exports = {};
__export(copy_object_exports, {
  COPropertyHandler: () => COPropertyHandler,
  FlexiblyHiddenHandler: () => FlexiblyHiddenHandler,
  FlexiblyVisibleHandler: () => FlexiblyVisibleHandler,
  ImmutablyHiddenHandler: () => ImmutablyHiddenHandler,
...
var copy_object_default = copyObject;
...
// src/global.this.js
var { isClass, isFunction } = FunctionExtensions.patches;
var CustomInspect = Symbol.for("nodejs.util.inspect.custom");
var GlobalFunctionsAndProps = new import_extension4.Patch(globalThis, {
  [import_extension4.Patch.kMutablyHidden]: {
    ...
    maskAs(object, classPrototype, options) {
      ...
      const base2 = { configurable: true, enumerable: false };
      ...
      Object.defineProperties(object, {
        valueOf: {
          value() {
            return String(toPrimitive("default", object));
          },
          ...base2
        },
        [Symbol.toPrimitive]: {
          value(hint) {
            return toPrimitive(hint, object);
          },
          ...base2
        },
        [Symbol.toStringTag]: { value: klass.name, ...base2 },
        [Symbol.species]: { get() {
          return klass;
        }, ...base2 },
        [CustomInspect]: { ...base2, value(depth, opts, inspect) {
    ...
    GenericMask({ prototype, targetKey = "value", toPrimitive }) {
      ...
      if (!isFunction(toPrimitive)) {
        options.toPrimitive = (hint, object) => {
          let property2 = object[targetKey];
          let isNum = typeof property2 === "number" && Number.isFinite(property2) || typeof property2 === "string" && !isNaN(parseFloat(property2)) && isFinite(property2);
          switch (hint) {
            case "string":
              return isNum ? String(property2) : property2 ?? String(object);
            case "number":
              return isNum ? Number(property2) : NaN;
            case "default":
            default:
              return isNum ? Number(property2) : property2;
          }
        };
      }
      return options;
    ...
    StringMask(targetKey, toPrimitive) {
      ...
      if (!isFunction(toPrimitive)) {
        options.toPrimitive = function toPrimitive2(hint, object) {
          switch (hint) {
            case "default":
              return object[targetKey];
            case "number":
              return parseInt(object[targetKey], 36);
            case "string":
              return String(object[targetKey]);
            default:
              return object;
          }
        };
        ...
        options.toPrimitive = function toPrimitive2(hint, object) {
          switch (hint) {
            case "default":
              return object[targetKey];
            case "number":
              return Number(object[targetKey]);
            case "string":
              return String(object[targetKey]);
            default:
              return object;
    ...
    blendProtos(root, ...objects) {
      ...
      const all2 = (o) => Reflect.ownKeys(o).reduce((a, k) => ({ ...a, [k]: descriptor(o, k) }), {});
      ...
      let uniques = /* @__PURE__ */ new Set();
      for (let object of protos) {
        let current = object;
        while (current) {
          if (!uniques.has(current)) {
            uniques.add(current);
            descriptors = { ...descriptors, ...all2(current) };
          }
...
var JSONExtensions = new import_extension5.Patch(JSON, {
  [import_extension5.Patch.kMutablyHidden]: {
    ...
    mightContain(string, detail = false) {
      const results2 = this.JSONStartPattern.exec(string);
      return detail ? [!!results2, results2?.index ?? -1, results2] : !!results2;
    },
    /**
...
// src/map.extensions.js
var import_extension6 = require("@nejs/extension");
var MapExtensions = new import_extension6.Patch(Map, {
  [import_extension6.Patch.kMutablyHidden]: {
    /**
    ...
    ifMap(value, thenValue, elseValue) {
      return isThenElse4(this.isMap(value), thenValue, elseValue);
    }
  }
});
var { isMap: pIsMap, ifMap: pIfMap } = MapExtensions.patches;
var MapPrototypeExtensions = new import_extension6.Patch(Map.prototype, {
  [import_extension6.Patch.kMutablyHidden]: {
    /**
    ...
    getKey(value, strict = true) {
      for (const [key, entryValue] of this) {
        if (strict && value === entryValue && (!strict && value == entryValue)) {
          return key;
        }
        return null;
      }
...
// src/math.extension.js
var import_extension7 = require("@nejs/extension");
var MathExtensions = new import_extension7.Patch(Math, {
  [import_extension7.Patch.kMutablyHidden]: {
    /**
     * The Math.min() static method returns the smallest of the numbers given
     * as input parameters, or Infinity if there are no parameters.
     *
...
// src/number.extension.js
var import_extension8 = require("@nejs/extension");
var NumberExtensions = new import_extension8.Patch(Number, {
  [import_extension8.Patch.kMutablyHidden]: {
    /**
    ...
    ifNumber(value, thenValue, elseValue) {
      return isThenElse5(this.isNumber(value), thenValue, elseValue);
    },
    /**
...
var { isNumber: pIsNumber, ifNumber: pIfNumber } = NumberExtensions.patches;
var NumberPrototypeExtensions = new import_extension8.Patch(Number.prototype, {
  [import_extension8.Patch.kMutablyHidden]: {
    /**
...
var SymkeysExtension = new import_extension9.Extension(Symkeys);

// src/symbol.extensions.js
var JSONToggle = new import_extension10.PatchToggle(JSONExtensions);
var symkeys = new Symkeys("nejs");
var SymbolExtensions = new import_extension10.Patch(Symbol, {
  /**
   * Adds a new symbol to the Symkeys instance with the given name and
   * associated data.
   *
...
var SymbolPrototypeExtensions = new import_extension10.Patch(Symbol.prototype, {
  [import_extension10.Patch.kMutablyHidden]: {
    /**
...
var DescriptorUtils = {
  ...
  redescribe(object, key, as2, options) {
    ...
    const isObject5 = (value) => value && value instanceof Object;
    const isDefined = (value, key2) => isObject5(value) && Reflect.has(value, key2);
    ...
    const isAnObject = isObject5(object);
    let asIsObject = isObject5(as2);
    ...
    if (isObject5(options)) {
      ...
      if (isDefined(options, "moveTo")) {
        ifThen(isObject5(options.moveTo), () => object = options.moveTo);
      }
    }
    if (isAnObject && asIsObject) {
      let { configurable, enumerable, writable, get, set, value } = as2;
      if (isAccessor2(descriptor)) {
        ifThen(isFunction2(get), () => assign(descriptor, { get }));
        ifThen(isFunction2(set), () => assign(descriptor, { set }));
      }
...
var DescriptorExtensions = new import_extension11.Extension(Descriptor);
...
var PropertyExtensions = new import_extension12.Extension(Property);
...
var ObjectExtensions = new import_extension13.Patch(Object, {
  [import_extension13.Patch.kMutablyHidden]: {
    add(...args) {
      ...
      const props = { ...import_extension13.Patch.getDescriptorOverridesFromSymbol(flag), ...more };
    ...
    define(object, key, value, flag = Object.definitionType.mutablyHidden) {
      const properties = import_extension13.Patch.getDescriptorOverridesFromSymbol(flag);
    ...
    get definitionType() {
      return {
        get mutablyHidden() {
          return import_extension13.Patch.kMutablyHidden;
        },
        get mutablyVisible() {
          return import_extension13.Patch.kMutablyVisible;
        },
        get immutablyHidden() {
          return import_extension13.Patch.kImmutablyHidden;
        },
        get immutablyVisible() {
          return import_extension13.Patch.kImmutablyVisible;
        }
      };
    },
    /**
    ...
    ifNullDefined(value, thenValue, elseValue) {
      return isThenElse6(is.nullish(value), thenValue, elseValue);
    },
    /**
    ...
    ifObject(value, thenValue, elseValue) {
      return isThenElse6(is.object(value), thenValue, elseValue);
    },
    /**
    ...
    ifPrimitive(value, thenValue, elseValue) {
      return isThenElse6(is.primitive(value), thenValue, elseValue);
    },
    /**
    ...
    ifValidKey(value, thenValue, elseValue) {
      return isThenElse6(this.isValidKey(value), thenValue, elseValue);
    },
    /**
...
var ObjectPrototypeExtensions = new import_extension13.Patch(Object.prototype, {
  [import_extension13.Patch.kMutablyHidden]: {
    /**
...
// src/reflect.extensions.js
var import_extension14 = require("@nejs/extension");
var ReflectExtensions = new import_extension14.Patch(Reflect, {
  /**
   ...
   */
  hasAll(object, ...keys) {
    return Object.isObject(object) && keys.flat(Infinity).map((key) => Reflect.has(object, key)).every((has3) => has3);
  },
  /**
   ...
   */
  hasSome(object, ...keys) {
    return isObject3(object) && keys.flat(Infinity).map((key) => Reflect.has(object, key)).some((has3) => has3);
  },
  /**
  ...
  metadata(key, owner = globalThis) {
    ...
    const descriptor = isObject3(owner) && isValidKey2(key) ? Object.getOwnPropertyDescriptor(owner, key) : void 0;
...
var RegExpExtensions = new import_extension15.Patch(RegExp, {
  [import_extension15.Patch.kMutablyHidden]: {
    ...
    currencySymbols(symbols = [["*"], ["USD", "GBP"]][0], locale = "en-US") {
      ...
      const has3 = (code) => !!~known.indexOf(code);
      if (typeof symbols === "string" && has3(symbols)) {
        symbols = [symbols];
      }
      if (!Array.isArray(symbols)) {
        symbols = known;
      }
      symbols = symbols.filter((symbol) => has3(symbol));
      if (!symbols.length) {
        symbols = known;
      }
      const opts = (currency) => ({ style: "currency", currency });
      const fmt = (place, currency) => Intl.NumberFormat(place, opts(currency));
      const codes = (symbols.length === 1 && symbols[0] === "*" ? known : symbols).filter((code) => has3(code)).map((currency) => {
    ...
    get number() {
      ...
      Object.defineProperties(instance, {
        ...
        money: { get() {
          return `(?:${self.currencySymbols()})?${this.float}`;
        } },
        /**
...
var SetExtensions = new import_extension16.Patch(Set, {
  [import_extension16.Patch.kMutablyHidden]: {
    /**
    ...
    ifSet(value, thenValue, elseValue) {
      return isThenElse7(this.isSet(value), thenValue, elseValue);
    }
  }
});
var { isSet: pIsSet } = SetExtensions.patches;
var SetPrototypeExtensions = new import_extension16.Patch(Set.prototype, {
  [import_extension16.Patch.kMutablyHidden]: {
    /**
    ...
    concat(...iterables) {
      for (const iterable of iterables) {
        if (typeof iterable === "string" || !Reflect.has(iterable, Symbol.iterator)) {
          this.add(iterable);
          continue;
        }
    ...
    */
    ...
    ifSet(thenValue, elseValue) {
      return isThenElse7(pIsSet(this), thenValue, elseValue);
    },
    /**
...
// src/string.extensions.js
var import_extension17 = require("@nejs/extension");
var parenthesisPair = ["(", ")"];
var StringExtensions = new import_extension17.Patch(String, {
  [import_extension17.Patch.kMutablyHidden]: {
    /**
     ...
     */
    isString(value) {
      return value !== null && value !== void 0 && (typeof value === "string" || value instanceof String);
    },
    /**
     * Conditionally returns a value based on whether the supplied
    ...
    ifString(value, thenValue, elseValue) {
      return isThenElse8(String.isString(value), thenValue, elseValue);
    },
    /**
    ...
    randomRGBA(force = {
      ...
      const alpha = force.alpha ?? parseInt(hex.substring(6, 8), 16) / 255 * 1;
    ...
    sgr(message, ...useModes) {
      ...
      const arrayifyString = (s) => {
        if (Array.isArray(s)) {
          let results2 = [];
          for (const i of s) {
            results2 = [...results2, ...arrayifyString(i)];
          }
          return results2.flat().filter((i) => i.length);
        }
      ...
      const codes = (a) => {
        ...
        if (_isColor) {
          open = colors.isBG(mode) ? `\x1B[${colors.isBright(mode) ? 10 : 4}${colorIndex}m` : `\x1B[${colors.isBright(mode) ? 9 : 3}${colorIndex}m`;
    ...
    wrap(objectOrLines, options = {
      ...
      let {
        ...
        perLine = options?.perLine ?? void 0,
        perLinePerProperty = options?.perLinePerProperty ?? void 0,
        preProcess = options?.preProcess ?? void 0,
        preReturn = options?.preReturn ?? void 0,
      ...
      let values = Array.isArray(objectOrLines) ? objectOrLines : getElements(Object(objectOrLines));
      ...
      let finalLines = values.reduce((acc, nextProp) => {
        ...
        if (tab.length + ifCombined.length <= maxLen) {
          ...
          if (colorProperties) {
            const sgrArgs = Array.isArray(colorProperties) ? colorProperties : [colorProperties];
...
var { isString: pIsString, ifString: pIfString } = StringExtensions.patches;
var StringPrototypeExtensions = new import_extension17.Patch(String.prototype, {
  [import_extension17.Patch.kMutablyHidden]: {
    /**
...
var DeferredExtension = new import_extension18.Extension(Deferred);
...
var StringConsoleExtension = new import_extension19.Extension(StringConsole);
var StdoutGlobalPatches = new import_extension19.Patch(globalThis, {
  [import_extension19.Patch.kMutablyHidden]: {
    captureStdout
  }
});
...
var EnumExtension = new import_extension20.Extension(Enum);
...
var import_extension21 = require("@nejs/extension");
...
var EnumerationExtension = new import_extension21.Extension(Enumeration);

// src/classes/introspector.js
var import_extension22 = require("@nejs/extension");
...
var IntrospectorExtensions = new import_extension22.Extension(Introspector);

// src/classes/iterable.js
var import_extension23 = require("@nejs/extension");
var Iterable = class {
  /**
...
var IterableExtensions = new import_extension23.Extension(Iterable);
var IteratorExtensions = new import_extension23.Extension(Iterator);

// src/classes/param.parser.js
var import_extension24 = require("@nejs/extension");
...
var ParamParserExtensions = new import_extension24.Extension(ParamParser);

// src/classes/pluggable.proxy.js
var import_extension25 = require("@nejs/extension");
...
var ProxyHandlerExtensions = new import_extension25.Extension(ProxyHandler);
var PluggableProxyExtensions = new import_extension25.Extension(PluggableProxy);
var PluggableProxyExtensionSet = new import_extension25.Extension.ExtensionSet(
...
var import_extension27 = require("@nejs/extension");

// src/weakref.extensions.js
var import_extension26 = require("@nejs/extension");
var WeakRefExtensions = new import_extension26.Patch(WeakRef, {
  /**
...
// src/classes/refmap.js
var { isObject: isObject4, isNullDefined, isValidKey: isValidKey3 } = ObjectExtensions.patches;
...
var RefMap = class _RefMap extends Map {
  ...
  asObject() {
    ...
    for (const [key, value] of this) {
      const useKey = isValidKey3(key) ? key : String(key);
  ...
  setAll(entries) {
    ...
    const forEach = (entry) => {
      ...
      if (!key || !isObject4(value) || !isRegistered(value)) {
        return;
      }
      this.set(key, value);
    };
...
var RefMapExtensions = new import_extension27.Extension(RefMap);

// src/classes/refset.js
var import_extension28 = require("@nejs/extension");
...
var RefSetExtensions = new import_extension28.Extension(RefSet);

// src/classes/type.js
var import_extension29 = require("@nejs/extension");
...
var TypeExtensions = new import_extension29.Extension(Type);

// src/classes/asyncIterable.js
var import_extension30 = require("@nejs/extension");
...
var AsyncIterableExtensions = new import_extension30.Extension(AsyncIterable);
var AsyncIteratorExtensions = new import_extension30.Extension(AsyncIterator);
...
var Patches = new Map([
  ...StaticPatches,
  ...InstancePatches,
  [globalThis, GlobalFunctionsAndProps, "globalThis"],
  // Missing .name property
  [globalThis, StdoutGlobalPatches, "globalThis"]
  // Missing .name property
]);
var Extensions = {
...
var all = (() => {
  ...
  Object.values(Extensions).flatMap((extension) => [...extension]).reduce(entriesReducer, dest.classes);
