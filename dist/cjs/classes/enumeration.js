...
exports.EnumerationExtension = exports.Enumeration = void 0;
exports.SubscriptProxy = SubscriptProxy;
...
class Enumeration {
    ...
    associate(...entries) {
        ...
        for (const entry of entries) {
            if (toolkit_js_1.is.object(entry, Object)) {
                Object.assign(associations, ...entries);
            }
            else if (toolkit_js_1.is.array(entry)) {
                const key = toolkit_js_1.is.objectKey(entry[0]);
                associations[key] = entry[1];
            }
            else if (toolkit_js_1.is.objectKey(entry)) {
    ...
    static define(key, value, customizeInstance) {
        ...
        else if (toolkit_js_1.is.object(customizeInstance)) {
 ...
 * @type {Extension}
 */
exports.EnumerationExtension = new extension_1.Extension(Enumeration);
